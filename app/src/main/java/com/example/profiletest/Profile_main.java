...
public class Profile_main extends AppCompatActivity implements TruyenUser{
    ...
    public void DataCauThu(CauThu cauThu) {
        Intent intent = new Intent(Profile_main.this, Fragment_Info.class);
        intent.putExtra("data",cauThu);
